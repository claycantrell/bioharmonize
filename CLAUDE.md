...
**YOU ARE IN: `bioharmonize/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/bioharmonize/` (rig root) or other directories
...
**Your mail address:** `bioharmonize/polecats/obsidian`
**Your rig:** bioharmonize
**Your Witness:** `bioharmonize/witness`
...
| Ask Witness for help | `gt mail send bioharmonize/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`bioharmonize/witness`) when:
...
```bash
gt mail send bioharmonize/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
